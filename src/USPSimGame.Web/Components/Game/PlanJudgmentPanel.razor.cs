...
public partial class PlanJudgmentPanel : ComponentBase, IDisposable
{
    ...
    [Inject] public USPSimGame.Application.Services.Costing.ICostCalculationService CostCalculationService { get; set; } = default!;
    ...
    private USPSimGame.Application.Services.Costing.PlanCostEstimate CostEstimate { get; set; }
