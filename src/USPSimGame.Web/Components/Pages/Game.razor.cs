...
using USPSimGame.Web.Components.Game;
...
public partial class Game : ComponentBase, IDisposable
{
    ...
    protected override void OnInitialized()
    {
        ...
        if (session != null && USPSimGame.Domain.Utils.GeoCoordinateConverter.TryParseLatLong(session.CenterLatLong, out double lat, out double lon))
        {
    ...
    [JSInvokable]
    public void OnMapFeaturesInspected(List<InspectedFeatureModel> clickedFeatures, double x, double y)
    {
