...
namespace USPSimGame.Web.Components.Game;
...
public partial class PlanAddEditPanel : ComponentBase, IDisposable
{
    ...
    [Inject]
    public USPSimGame.Application.Services.Costing.ICostCalculationService CostCalculationService { get; set; } = default!;

    [Inject]
    public IJSRuntime JSRuntime { get; set; } = default!;

    [Inject]
    public USPSimGame.Application.Services.PlayerSessionState PlayerSessionState { get; set; } = default!;
    ...
    protected USPSimGame.Application.Services.Costing.PlanCostEstimate CurrentPlanCost { get; set; }
    ...
    protected void ValidateSelectedTargetDate()
    {
        ...
        if (selectedTargetMonth < MinimumAllowedCompletionMonth)
        {
            ...
            string reqStartFormatted = USPSimGame.Domain.Utils.CommonGameUtils.FormatMonthYear(reqStartMonth, StartYear);
            string minCompFormatted = USPSimGame.Domain.Utils.CommonGameUtils.FormatMonthYear(MinimumAllowedCompletionMonth, StartYear);
            string selTargetFormatted = USPSimGame.Domain.Utils.CommonGameUtils.FormatMonthYear(selectedTargetMonth, StartYear);
