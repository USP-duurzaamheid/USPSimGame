...
public partial class GameOverlay : ComponentBase, IDisposable
{
    ...
    public string FormattedGameDate
    {
        get
        {
            ...
            return USPSimGame.Domain.Utils.CommonGameUtils.FormatMonthYear(session.CurrentMonth, startYear);
        }
    }
    ...
    private async Task HandleSessionStateChangedAsync(USPSimGame.Domain.Entities.GameSession updatedSession)
    {
